const CACHE_VERSION = 'hg-radar-industrial-v16-7-rollback-clean-mobile-v1';
  ...
  event.waitUntil(
    caches.keys()
      .then((keys) => Promise.all(
        keys
          .filter((key) => (key.startsWith('hg-radar-') || key.startsWith('hg-radar-industrial-')) && key !== STATIC_CACHE)
